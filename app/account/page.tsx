        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_320px]">
          <div className="grid gap-6">
            ...
            <div className="grid gap-5 sm:grid-cols-3">
              <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <p className="mt-2 text-sm text-slate-600">Pay securely via Paddle.</p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-6 rounded-2xl bg-blue-50 p-5">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-600">You are signed in with Google. Digital product delivery is handled automatically by Paddle after successful checkout.</p>
              </div>
          ...
          <aside className="h-fit rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 grid gap-3">
              <Link href="/purchases" className="rounded-xl bg-blue-600 px-5 py-3 text-center text-sm font-semibold text-white hover:bg-blue-700">📥 My Downloads</Link>
