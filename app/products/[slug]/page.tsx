        ...
        <section className="mx-auto max-w-6xl px-6 py-16">
              ...
              <div className="mt-8 grid gap-3 sm:grid-cols-3">
                {polarCheckoutLink && (
                  <a
                    ...
                    className="inline-flex items-center justify-center rounded-xl bg-blue-600 px-6 py-3 font-semibold text-white shadow-sm transition hover:bg-blue-700 sm:col-span-1"
                  >
          ...
          <section className="mt-10 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-4 text-slate-600">
              Customers can pay directly through Polar checkout or request an
              invoice by email. Digital products are delivered electronically by
