export const metadata = { title: "FAQ | Narostack Digital LLC", description: "Frequently asked questions about Narostack Digital LLC downloadable digital products, delivery, refunds, invoices, and product access." };
...
const faqs = [
  ...
  { question: "Can I pay online?", answer: "Yes. You can pay securely through Dodo Payments on any product page, in your cart, or through the checkout page. You can also request an invoice by email if preferred." },
  ...
  { question: "Can I request an invoice?", answer: "Yes. Use the checkout page to fill in your details and send an invoice request by email. Invoice instructions will be sent to you by email." },
  ...
  return (
    <main className="bg-slate-50">
      <section className="mx-auto max-w-4xl px-6 py-16">
        ...
        <p className="mt-5 text-lg leading-8 text-slate-600">Find answers about Narostack Digital LLC downloadable products, digital delivery, payment, invoice requests, refunds, and product access.</p>
